...
export const projects:Project[]=[
 ...
 {name:"Profile / Blog Index",summary:"面向技术交流的个人主页与 Issue Blog",description:"用 GitHub Issues 管理文章，用 Pages 自动发布，把项目、能力与思考放在一个入口。",status:"building",tags:["Frontend","Content System"],stack:["React","Vite","GitHub Pages"],url:"https://profile.yangzx1.xyz",repository:"https://github.com/yanlong832-source/profile-website",accent:"lilac",metrics:[{label:"部署",value:"自动化"},{label:"内容",value:"Issues"}]},
