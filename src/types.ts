...
export type Issue={number:number;title:string;body:string;labels:string[];created_at:string;updated_at:string;html_url:string;likes:number;comments:number};
