...
function Hero({ navigate }: { navigate: (view: View) => void }) {
  return <section className="hero figma-section"><div className="hero-title"><h1>杨智雄</h1><p>// 后端 / AI / DevOps 工程师</p></div><p className="hero-copy">专注高并发服务、低延迟数据链路和 LLM Agent 系统，使用自动化云部署把可靠的工程方案交付到线上。</p><div className="hero-links"><a className="button-dark" href="mailto:2907145367@qq.com">✉ <span>邮件联系</span></a><a className="github-link" href="https://github.com/yanlong832-source" target="_blank" rel="noreferrer" aria-label="打开 GitHub 主页" title="GitHub 主页"><svg className="github-icon" viewBox="0 0 24 24" aria-hidden="true"><path fill="currentColor" d="M12 .5a12 12 0 0 0-3.79 23.39c.6.11.82-.26.82-.58v-2.04c-3.34.73-4.04-1.61-4.04-1.61-.55-1.39-1.34-1.76-1.34-1.76-1.09-.75.08-.74.08-.74 1.2.08 1.83 1.23 1.83 1.23 1.07 1.83 2.8 1.3 3.48.99.11-.77.42-1.3.76-1.6-2.67-.3-5.47-1.34-5.47-5.95 0-1.31.47-2.38 1.23-3.22-.12-.3-.54-1.52.12-3.17 0 0 1-.32 3.3 1.23a11.5 11.5 0 0 1 6 0c2.29-1.55 3.3-1.23 3.3-1.23.66 1.65.24 2.87.12 3.17.76.84 1.23 1.91 1.23 3.22 0 4.62-2.81 5.64-5.48 5.94.43.37.81 1.1.81 2.22v3.29c0 .32.22.69.83.57A12 12 0 0 0 12 .5Z" /></svg></a><i></i><a href="mailto:2907145367@qq.com">QQ 邮箱</a><i></i><button onClick={() => navigate("projects")}>查看项目 <Arrow /></button></div></section>;
}
